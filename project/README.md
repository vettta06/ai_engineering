...
Проект посвящён созданию сервиса оценки кредитного риска на основе табличных данных клиента банка. 
Используется открытый датасет German Credit Data, проводится обучение бинарного классификатора. 
Результат – REST API на FastAPI, принимающий характеристики клиента и возвращающий вероятность дефолта.
...
Для обучения используется открытый датасет **German Credit Data**.- где лежат файлы:
